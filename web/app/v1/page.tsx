...
import { stopLiveView, setLiveViewSource } from '@/lib/api';
...
export default function V1ClassicCockpitPage() {
  ...
  return (
    <div className="h-screen w-screen bg-slate-950 text-white grid grid-cols-[460px_1fr] grid-rows-[auto_1fr] overflow-hidden font-sans">
