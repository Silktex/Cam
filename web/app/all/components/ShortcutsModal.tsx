...
const shortcuts: { section: string; items: Shortcut[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { action: 'Toggle Light 1', mac: '1', win: '1', scope: 'Dashboard' },
      { action: 'Toggle Light 2', mac: '2', win: '2', scope: 'Dashboard' },
      { action: 'Toggle Light 3', mac: '3', win: '3', scope: 'Dashboard' },
      { action: 'Toggle Light 4', mac: '4', win: '4', scope: 'Dashboard' },
      { action: 'Toggle Light 5', mac: '5', win: '5', scope: 'Dashboard' },
      { action: 'Toggle Light 6', mac: '6', win: '6', scope: 'Dashboard' },
      { action: 'Toggle Light 7', mac: '7', win: '7', scope: 'Dashboard' },
      { action: 'Toggle Light 8', mac: '8', win: '8', scope: 'Dashboard' },
    ],
  },
  {
    section: 'Camera',
