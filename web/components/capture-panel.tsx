  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-4 relative">
      ...
      {isCapturing && (
        <div className="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-2xl flex items-center justify-center z-10">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-sm font-medium text-slate-700">Capturing image...</span>
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-slate-800">Image Capture</h2>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm disabled:bg-slate-50 disabled:cursor-not-allowed"
          />
          <p className="text-xs text-slate-500 mt-1">Saves to: media/captures/{folder}/</p>
        </div>
        ...
        {/* Last Capture Result */}
        {lastCapture && (
          <div className={`p-3 rounded-xl ${lastCapture.success ? 'bg-teal-50 border border-teal-200' : 'bg-red-50 border border-red-200'}`}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className={`text-sm font-medium ${lastCapture.success ? 'text-teal-700' : 'text-red-700'}`}>
                {lastCapture.message}
              </span>
            </div>
